...
class CategoryController extends Controller
{
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(30,'view');
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(30,'create');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(30,'edit');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(30,'delete');
