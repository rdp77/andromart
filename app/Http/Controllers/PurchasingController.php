...
class PurchasingController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        return view('pages.backend.transaction.purchasing.indexPurchasing');
    }
    ...
    public function create()
    {
        ...
        return view('pages.backend.transaction.purchasing.createPurchasing',compact('employee','code','items'));
    }
