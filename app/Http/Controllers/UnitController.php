...
class UnitController extends Controller
{
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(27,'view');
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(27,'create');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(27,'edit');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
