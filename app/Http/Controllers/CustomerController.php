...
class CustomerController extends Controller
{
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(23,'view');
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(23,'create');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(23,'edit');
        if($checkRoles == 'akses ditolak'){
            return view('forbidden');
        }
    ...
    {
        $checkRoles = $this->DashboardController->cekHakAkses(23,'delete');
