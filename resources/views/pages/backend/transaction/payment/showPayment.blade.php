...
@section('title', __('pages.title') . __(' | Lihat Pengeluaran'))
@section('titleContent', __('Lihat Pengeluaran'))
@section('breadcrumb', __('Data'))
@section('morebreadcrumb')
    <div class="breadcrumb-item active">{{ __('Pengeluaran') }}</div>
    <div class="breadcrumb-item active">{{ __('Lihat Pengeluaran') }}</div>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="code" type="text" class="form-control" disabled readonly=""
                                    value="{{ $payment->code }}" name="code">
                                <input id="id" type="hidden" disabled class="form-control" readonly="" value="{{ $payment->id }}"
                                    name="id">
                            </div>
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input id="date" type="text" data-name="Tanggal Harus Di isi"
                                    ...
                                    value="{{ $payment->date }}" disabled name="date">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4 col-xs-12">
                                ...
                                <select onchange="branchChange()" disabled data-name="Cabang Harus Di isi"
                            ...
                            <div class="form-group col-md-8 col-xs-12">
                                ...
                                <select class="select2 validation type_id" disabled data-name="Tipe Harus Di isi"
                            ...
                            <div class="form-group col-md-6 col-xs-12">
                                ...
                                <select class="select2 validation" disabled data-name="Kas Harus Di isi" name="cash_id" required>
                                    <option value="">- Select -</option>
                                    @foreach ($cash as $el)
                                        @if ($el->main_id == 1)
                            ...
                            @foreach ($cash as $el)
                                @if ($el->debet_kredit == 'K')
                                    ...
                                    @endif type="hidden" disabled data-branch="{{ $el->branch_id }}"
                            ...
                            <div class="form-group col-md-6 col-xs-12">
                                ...
                                <select disabled class="select2 validation cost @error('cost_id') is-invalid @enderror"
                        ...
                        <div class="row checkTransfer" style="display: none" disabled>
                            <div class="form-group col-md-12 col-xs-12">
                                <div class="d-block">
                                    <label for="cash_tranfer_id"
                                        class="control-label">{{ __('Transfer Ke') }}<code>*</code></label>
                                </div>
                                <select disabled class="select2 validation" data-name="Transfer Harus Di isi" name="cash_tranfer_id">
                                    <option value="">- Select -</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-5 col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="rupiah" disabled type="text" data-name="Jumlah Pembayaran Harus Di isi"
                                        value="{{ $payment->price }}"
                            ...
                            <div class="form-group col-md-7 col-xs-12">
                                ...
                                <input id="description" disabled type="text" value="{{ $payment->description }}"
