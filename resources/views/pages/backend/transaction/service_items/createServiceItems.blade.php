    ...
    <form class="form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-4 col-lg-4">
                                ...
                                <select class="select2 type validation" data-name="Kategori" name="type"
                                    onchange="category()">
                                    <option value="">- Select -</option>
                            ...
                            <div class="form-group col-12 col-md-4 col-lg-4">
                                ...
                                <select class="select2 brand form-control validation" data-name="Merk" id="brandService"
                                    name="brand">
                                    <option value="">- Select -</option>
                            ...
                            @foreach ($brand as $el)
                                <input class="brandData" type="hidden" data-category="{{ $el->category_id }}"
                                    data-name="{{ $el->name }}" value="{{ $el->id }}">
                            @endforeach

                            @foreach ($type as $el)
                                <input class="seriesData" type="hidden" data-brand="{{ $el->brand_id }}"
                                    data-name="{{ $el->name }}" value="{{ $el->id }}">
                            @endforeach
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6 col-lg-6">
                                ...
                                <input id="complaint" type="text" class="form-control validation" data-name="Komplain"
                                    name="complaint">
                            </div>
                            <div class="form-group col-12 col-md-6 col-lg-6">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-12 col-lg-12">
                                ...
                                <input id="description" type="text" class="form-control validation" data-name="Deskripsi"
                                    name="description">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="chargerEquipment"
                                        class="chargerEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Charger</span>
                                </label>
                                <div class="chargerEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="chargerEquipmentDesc" type="text" class="form-control"
                                        name="chargerEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="bateraiEquipment"
                                        class="bateraiEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Baterai</span>
                                </label>
                                <div class="bateraiEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="bateraiEquipmentDesc" type="text" class="form-control"
                                        name="bateraiEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="hardiskSsdEquipment"
                                        class="hardiskSsdEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Hardisk / SSD</span>
                                </label>
                                <div class="hardiskSsdEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="hardiskSsdEquipmentDesc" type="text" class="form-control"
                                        name="hardiskSsdEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                ...
                                <div class="RamEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="RamEquipmentDesc" type="text" class="form-control"
                                        name="RamEquipmentDesc">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="kabelEquipment"
                                        class="kabelEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Kabel</span>
                                </label>
                                <div class="kabelEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="kabelEquipmentDesc" type="text" class="form-control"
                                        name="kabelEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="tasLaptopEquipment"
                                        class="tasLaptopEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Tas Laptop</span>
                                </label>
                                <div class="tasLaptopEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="tasLaptopEquipmentDesc" type="text" class="form-control"
                                        name="tasLaptopEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="aksesorisEquipment"
                                        class="aksesorisEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Aksesoris</span>
                                </label>
                                <div class="aksesorisEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="aksesorisEquipmentDesc" type="text" class="form-control"
                                        name="aksesorisEquipmentDesc">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-3 col-lg-3">
                                <label class="custom-switch mt-2" style="margin-left: -30px !important">
                                    <input type="checkbox" name="lainnyaEquipment"
                                        class="lainnyaEquipment custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Lainnya</span>
                                </label>
                                <div class="lainnyaEquipmentDescUsed" style="display: none">
                                    <hr>
                                    <input id="lainnyaEquipmentDesc" type="text" class="form-control"
                                        name="lainnyaEquipmentDesc">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-md-4 col-lg-4">
                                ...
                                <input id="presentaseTechnician1" type="text" value="0"
                                    class="form-control cleaveNumeral" name="presentaseTechnician1"
                                    style="text-align: right">
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-4">
                                <lab,el for="presentaseTechnician2">{{ __('Presentase Teknisi 2') }}<code>*</code></label>
                                    <input id="presentaseTechnician2" type="text" value="0"
                                        class="form-control cleaveNumeral" name="presentaseTechnician2"
                                        style="text-align: right">
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-4">
                                <lab,el for="presentaseStore">{{ __('Presentase Toko') }}<code>*</code></label>
                                    <input id="presentaseStore" type="text" value="0"
                                        class="form-control cleaveNumeral" name="presentaseStore"
                                        style="text-align: right">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <input id="totalDownPayment" type="text" value="0"
                        ...
                        <div class="form-group">
                            ...
                            <input readonly id="totalPrice" type="text" value="0"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="totalPriceSell" type="text" value="0" class="form-control cleaveNumeral"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="totalHppAtas" type="text" readonly value="0"
                                class="form-control cleaveNumeral" name="totalHppAtas" style="text-align: right">
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="LcdCondition" value="Y" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-check"></i></span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="LcdCondition" value="N" class="selectgroup-input">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="wifiCondition" value="Y" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-check"></i></span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="wifiCondition" value="N" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-times"></i></span>
                                </label>
                                <label class="selectgroup-item">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="micCondition" value="Y" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-check"></i></span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="micCondition" value="N" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-times"></i></span>
                                </label>
                                <label class="selectgroup-item">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="usbCondition" value="Y" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-check"></i></span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="usbCondition" value="N" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-times"></i></span>
                                </label>
                                <label class="selectgroup-item">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @foreach ($item as $el)
                    <input class="itemsData" type="hidden" data-price="{{ $el->sell }}"
                        data-brand="{{ $el->brand_id }}" data-hpp="{{ $el->buy }}" data-buy="{{ $el->buy }}"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" class="form-control priceHpp" name="priceHpp[]"
                                        value="0">
                                </td>
                                <td>
                                    <input readonly type="text" class="form-control" name="qtyDetail[]"
                                        value="1" style="text-align: right">
                                </td>
                                <td>
                                    <input readonly type="text" class="form-control" name="stockDetail[]"
                                        value="1" style="text-align: right">
                                </td>
                                <td>
                                    <input readonly type="text"
                                        class="form-control totalPriceServiceDetail cleaveNumeral"
                                        name="totalPriceDetail[]" style="text-align: right" value="0">
                                    <input readonly type="hidden" class="form-control totalPriceHpp"
                                        name="totalPriceHpp[]" value="0" style="text-align: right">
                                </td>
                                <td>
            ...
            <div class="card-footer text-right">
                <button class="btn btn-primary mr-1 tombolSave" type="button" onclick="save()"><i
                        class="far fa-save"></i>
                    {{ __('Simpan Data') }}</button>
                <button class="btn btn-warning mr-1 tombolPrint" style="display: none" type="button"
                    onclick="print('{{ URL::to('/') }}')"><i class="fas fa-print"></i>
