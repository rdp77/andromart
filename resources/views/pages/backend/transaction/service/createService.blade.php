            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input readonly id="totalService" type="text" class="form-control" name="totalService">
                    </div>
                    <div class="form-group">
                        <label for="totalSparePart">{{ __('Spare Part') }}<code>*</code></label>
                        <input readonly id="totalSparePart" type="text" class="form-control" name="totalSparePart">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-6">
                            ...
                            <input id="totalDiscountValue" type="text" class="form-control" name="totalDiscountValue">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input readonly type="text" class="form-control " name="itemsDetail[]" value="Jasa">
                            </td>
                            <td>
