                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                >>>>>>> dffa2b9949e5f7601885eeea96ef366b9054462b
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12 col-md-4 col-lg-4">
                        ...
                        <<<<<<< HEAD <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly id="totalLoss" type="text" class="form-control" name="totalLoss">
                                </div>
                                <div class="form-group">
                                    <label for="totalDownPayment">{{ __('Down Payment (DP)') }}<code>*</code></label>
                                    <input id="totalDownPayment" type="text" class="form-control cleaveNumeral"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="totalPrice" type="text" class="form-control" name="totalPrice">
                                </div>
                                =======
                                <div class="card">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="selectgroup w-100">
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="verificationPrice" value="Y"
                                                        onchange="sumTotal()" class="selectgroup-input">
                                                    <span class="selectgroup-button">Ya</span>
                                                </label>
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="verificationPrice" value="N"
                                                        onchange="sumTotal()" checked class="selectgroup-input">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly id="totalService" onchange="sumTotal()" type="text"
                                                value="0" class="form-control" name="totalService">
                                        </div>
                                        <div class="form-group">
                                            <label for="totalSparePart">{{ __('Spare Part') }}<code>*</code></label>
                                            <input readonly id="totalSparePart" onchange="sumTotal()" type="text"
                                                value="0" class="form-control" name="totalSparePart">
                                        </div>
                                        <div class="form-group">
                                            <label for="totalLoss">{{ __('Total Loss') }}<code>*</code></label>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="totalDownPayment">{{ __('Down Payment (DP)') }}<code>*</code></label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                <label
                                                    for="totalDiscountPercent">{{ __('Diskon %') }}<code>*</code></label>
                                                <input id="totalDiscountPercent" type="text" value="0"
                                                    class="form-control" name="totalDiscountPercent"
                                                    onkeyup="sumTotal(),sumDiscont()">
                                            </div>
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                <label for="totalDiscountValue">{{ __('Diskon') }}<code>*</code></label>
                                                <input id="totalDiscountValue" type="text" value="0"
                                                    class="form-control" name="totalDiscountValue"
                                                    onkeyup="sumTotal(),sumDiscont()">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input readonly type="text"
                                                                class="form-control totalPriceServiceDetail"
                                                        ...
                                                        <td><button href="#" type="button"
                                                                class="btn btn-default">X</button></td>
                                                    </tr>
                                                </tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="#" class="btn btn-danger">X</a></td>
                                ...
                                <div class="card-footer text-right">
                                    <button class="btn btn-primary mr-1" type="button" onclick="save()"><i
                                            class="far fa-save"></i>
