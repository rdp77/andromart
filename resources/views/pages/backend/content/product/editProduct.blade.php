...
<div class="card">
    <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row">
                <input type="hidden" name="type_products_id" value="{{ $product->type_products_id }}"/>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="prize" type="number" class="form-control @error('prize') is-invalid @enderror" name="prize" value="{{ $product->prize }}" required autofocus/>
                    @error('prize')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="discount" type="number" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ $product->discount }}" autofocus/>
                    @error('discount')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-12 col-xs-12">
                    ...
                    <div class="selectgroup w-100">
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="hot_item" value="0"
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <textarea class="summernote @error('description') is-invalid @enderror" id="description" name="description"> {{ $product->description }}</textarea>
                    @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <textarea class="summernote @error('detail') is-invalid @enderror" id="detail" name="detail">{{ $product->detail }}</textarea>
                    @error('detail')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="tokopedia" type="text" class="form-control @error('tokopedia') is-invalid @enderror" name="tokopedia" value="{{ $product->tokopedia }}" autofocus/>
                    @error('tokopedia')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="shopee" type="text" class="form-control @error('shopee') is-invalid @enderror" name="shopee"  value="{{ $product->shopee }}"autofocus/>
                    @error('shopee')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="lazada" type="text" class="form-control @error('lazada') is-invalid @enderror" name="lazada"  value="{{ $product->lazada }}"autofocus/>
                    @error('lazada')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="bukalapak" type="text" class="form-control @error('bukalapak') is-invalid @enderror" name="bukalapak" value="{{ $product->bukalapak }}" autofocus/>
                    @error('bukalapak')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="olx" type="text" class="form-control @error('olx') is-invalid @enderror" name="olx" value="{{ $product->olx }}" autofocus/>
                    @error('olx')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="blibli" type="text" class="form-control @error('blibli') is-invalid @enderror" name="blibli" value="{{ $product->blibli }}" autofocus/>
                    @error('blibli')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="jd" type="text" class="form-control @error('jd') is-invalid @enderror" name="jd" value="{{ $product->jd }}" autofocus/>
                    @error('jd')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 col-xs-12">
                    ...
                    <input id="bhinneka" type="text" class="form-control @error('bhinneka') is-invalid @enderror" name="bhinneka" value="{{ $product->bhinneka }}" autofocus/>
                    @error('bhinneka')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="card-footer text-right">
            ...
            <button class="btn btn-primary mr-1" type="submit">Ubah Product</button>
        </div>
    </form>
</div>
@endsection
