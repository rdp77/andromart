      ...
      <div class="col-12 col-md-5 col-lg-5">
        <div class="card profile-widget">
          <div class="profile-widget-header">
            <img alt="image" src="{{ Auth::user()->employee->getAvatar() }}" class="rounded-circle profile-widget-picture" title="{{ Auth::user()->name }}">
          ...
          <div class="profile-widget-description">
            <div class="profile-widget-name">NIK
              ...
              <div class="profile-widget-name">T. Tanggal Lahir
                  <div class="text-muted d-inline font-weight-normal">
                      <div class="slash"></div> {{ $user->employee->birthday }}
                  </div>
              </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-4 col-12">
                    ...
                    {{-- <input id="birthday" type="text" class="form-control datepicker" name="birthday" value="{{ Carbon::parse($row->date)->locale('id')->isoFormat('LL') }}"> --}}
                  </div>
                  <div class="form-group col-md-6 col-12">
